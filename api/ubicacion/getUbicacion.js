import { obtenerPronostico } from "./getPronostico";
...
export async function obtenerUbicacion(lat, lon, unit) {
    ...
    try {
        ...
        const pronostico = await obtenerPronostico(lat, lon, unit);

              return { ciudad, pais, temp, desc, icon, speed, deg, humidity, visibility, pressure, pronostico };
