        ...
        <div className='flex flex-col w-screen h-screen bg-slate-950'>
            ...
            <div className='w-full min-h-screen bg-slate-950'>
                ...
                <div className='flex flex-wrap px-16 gap-5'>
                    <div className='flex flex-col items-center text-white text-sm h-40 w-28 border shadow bg-slate-800 p-4 gap-2'>
                        <div>Dia</div>
                        <div>
            ...
            <div className='flex flex-col w-full text-white min-h-screen bg-slate-950 py-2 px-8 gap-4'>
